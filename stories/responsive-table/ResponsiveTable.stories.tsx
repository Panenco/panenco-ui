...
import { ResponsiveTable, SortType } from 'components/responsive-table';
import { Button, Col, Row, SelectInput, TextInput } from 'components';
...
const DemoTemplate = () => {
  ...
  const [sort, setSort] = React.useState<SortType | undefined>(defaultSort);
