  ...
  return (
    <WrappedComponent>
      <Row className="mb-1 mt-1 justify-around">
        <Col xs="5" sm="5" lg="5">
          <Tooltip arrow content="Tooltip message will show up here." position="right">
            RIGHT
          </Tooltip>
        </Col>
      ...
      <Row className="mb-1 mt-1 justify-around">
        <Col xs="5" sm="5" lg="5">
          <Tooltip arrow content="Tooltip message will show up here" position="bottom">
            BOTTOM
          </Tooltip>
        </Col>
        <Col xs="5" sm="5" lg="5" className="ml-1">
          <Tooltip arrow content="Tooltip message will show up here" position="left">
            LEFT
          </Tooltip>
        </Col>
      </Row>
